...
public class BusquedaGUI extends javax.swing.JFrame {
    ...
    //Desde CheckInGUI 
    public BusquedaGUI(CheckInGUI checkinGUI) {
        initComponents();
    ...
    //Desde CheckoutGUI
    public BusquedaGUI(CheckOutGUI checkoutGUI){
       initComponents();
    ...
    //Desde GUIinicial
    public BusquedaGUI(GUI GUIinicial) {
        initComponents();
    ...
    public BusquedaGUI(BusquedaResGUI busquedaresGUI) {
        initComponents();
    ...
    //Desde HistorialGUI
    public BusquedaGUI(HistorialGUI historialGUI) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 460, 60));

        pack();
    }// </editor-fold>//GEN-END:initComponents
    /**
     * Metodo para volver a la interfaz inicial
     * @param evt 
     */
    ...
    /**
     * Metodo para ir a la interfaz Checkout
     * @param evt 
     */
    ...
    private void buscarclientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarclientActionPerformed
        ...
        if (resultadoBusqueda != null) {
            ...
            String info = "Nombre y apellido: " + cliente.getF_name() + " " + cliente.getL_name() + ". Número de habitación: " + cliente.getRoomNum();
